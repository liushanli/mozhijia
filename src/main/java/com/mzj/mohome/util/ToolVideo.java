...
//  private static final Logger LOG = LoggerFactory.getLogger(ToolVideo.class);
    ...
    public static void main(String[] args) {
       /* Map<String, Object> screenshot = getScreenshot("E:/20210618/compress_video_1087340041.mp4");
        System.out.println(screenshot.toString());*/
       /* String str = "http://wx.mzjsh.com:8888/Upload/1376150086949670912.mp4";
        String na = str.substring(str.lastIndexOf("8/")+1);*/
       // System.out.println(na);


        List<String> list = ToolsUtil.processImg("E:/20210618/compress_video_1087340041.mp4","D:\\work\\ffmpeg.exe");
        ...
        if(list.size()==13){
            ...
            String imageName = ImageUtil.exportImg2("D:/work/Admin/Upload/zanting.png",imgUrl,"D:/work/Admin/Upload/worker_ImgUrl/"+f+"/");
